...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 15.4826
    #define DEFAULT_Ki 0.9904
    #define DEFAULT_Kd 60.5060
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 75.9271
  #define DEFAULT_bedKi 7.8926
  #define DEFAULT_bedKd 486.9459
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 101.9208}
