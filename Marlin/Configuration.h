...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  11.2945
    #define DEFAULT_Ki   0.5238
    #define DEFAULT_Kd  60.8870
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  66.3006
  #define DEFAULT_bedKi   6.4614
  #define DEFAULT_bedKd 453.5402
#endif // PIDTEMPBED
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.24, 80.54, 400, 411}
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0.24 }
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 100.1467
  #define XY_DIAG_BD 100.12
  #define XY_SIDE_AD 70.4962

  // Or, set the default skew factors directly here
  // to override the above measurements:
  // #define XY_SKEW_FACTOR 0.012792
