...
#define STRING_CONFIG_H_AUTHOR "(Drew Moseley, CR-6 SE with stock motherboard, custom)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  18.5093
    #define DEFAULT_Ki   1.3994
    #define DEFAULT_Kd  61.2055
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  85.2728
  #define DEFAULT_bedKi   8.7910
  #define DEFAULT_bedKd 551.4311
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0.3480 }
...
#define Z_PROBE_FEEDRATE_FAST ((10 * 60) / 2)
...
#define PROBING_HEATERS_OFF       // Turn heaters off when probing
  ...
  #define PROBING_KEEP_BED_HEATER
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 141.388
  #define XY_DIAG_BD 140.9833
  #define XY_SIDE_AD 99.987

  // Or, set the default skew factors directly here
  // to override the above measurements:
  //#define XY_SKEW_FACTOR 0.00286334

  #define SKEW_CORRECTION_FOR_Z
  #if ENABLED(SKEW_CORRECTION_FOR_Z)
    #define XZ_DIAG_AC 140.908644495168
    #define XZ_DIAG_BD 141.929086589447
    #define YZ_DIAG_AC 141.078519341022
    #define YZ_DIAG_BD 141.327636617552
    #define YZ_SIDE_AD 99.68
    //#define XZ_SKEW_FACTOR -0.00720811
    //#define YZ_SKEW_FACTOR -0.00175313
  #endif
