...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_CREALITY_V521
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    // DREW: M303 C5 E0 S200 U1; M303 C5 E1 S200 U1
    #define DEFAULT_Kp_LIST {  29.12,  38.28 }
    #define DEFAULT_Ki_LIST {   3.19,   4.31 }
    #define DEFAULT_Kd_LIST {  66.39,  84.97 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // DREW: M303 C5 E-1 S60 U1
  #define DEFAULT_bedKp 256.55
  #define DEFAULT_bedKi 34.48
  #define DEFAULT_bedKd 1272.47
#endif // PIDTEMPBED
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 60, 60 }    // added by John Carlson to up limits
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 3000, 3000, 300, 9999 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -1.5, 27, 0 }
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (10*60) } // John Carlson Homing speed-up
